...
# Model constructors + neighborhood definitions live at the model level.
...
@testset "TNMP marginals on a grid" begin
    ...
    @testset "larger L drives the approximation toward exact" begin
        ...
        cache3 = TNMPCache(psi, 3; region_fn = grid_region_fn(3))
        ...
        cache5 = TNMPCache(psi, 5; region_fn = grid_region_fn(5))
...
include("test_complexity_probe.jl")
...
include("test_potts_model.jl")
include("test_tnmp_subtn_einsum.jl")
